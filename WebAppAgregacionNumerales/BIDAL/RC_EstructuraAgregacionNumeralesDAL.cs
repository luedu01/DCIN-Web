            ...
            using (TdConnection oSqlConnection = new TdConnection(Cnn))
            {
                try
                {
                    ...
                    using (TdCommand oSqlCmd = new TdCommand())
                    {
                        ...
                        oSqlCmd.CommandText = "Select * from " + @instancia + ".V_RC_EstructuraAgregacionNumerales where Cb_Eliminado <> 'S'";
                ...
                try
                {
                    ...
                    oSqlConnection.Open();
                        ...
                        using (TdCommand oSqlCmd = new TdCommand())
                        {
                            ...
                            Fecha_InicioVigenciaP.Direction = ParameterDirection.Input;
                            oSqlCmd.Parameters.Add(Fecha_InicioVigenciaP);
                            Fecha_InicioVigenciaP.Value = estructura.Fecha_InicioVigencia;

                            TdParameter Fecha_FinVigenciaP = oSqlCmd.CreateParameter();
                            Fecha_FinVigenciaP.DbType = DbType.DateTime;
                            Fecha_FinVigenciaP.Direction = ParameterDirection.Input;
                            oSqlCmd.Parameters.Add(Fecha_FinVigenciaP);
                            Fecha_FinVigenciaP.Value = estructura.Fecha_FinVigencia;
                            ...
                            if (estructura.Fecha_Eliminado == null)
                            {
                            ...
                            else
                            {
                                ...
                                Fecha_EliminadoP.Direction = ParameterDirection.Input;
                                oSqlCmd.Parameters.Add(Fecha_EliminadoP);
                                Fecha_EliminadoP.Value = estructura.Fecha_Eliminado;
                            }
                        ...
                        using (TdConnection oSqlConnection = new TdConnection(Cnn))
                        {
                            ...
                            oSqlConnection.Open();
                                ...
                                using (TdCommand oSqlCmd = new TdCommand())
                                {
                                    ...
                                    " COALESCE((SEL Sk_NodoContable FROM  " + instancia + ".V_RC_NodoContableAgregacionNumerales WHERE Desc_NodoContable = ? AND Id_NodoContable = ? AND Id_Estructura = ?),'-1') Sk_NodoContablePadre , " +
                                    ...
                                    "   ON ACT.Desc_NodoContable = ? AND  ACT.Id_NodoContable=? AND ACT.Id_Estructura=? " +
                                    " ) AS T2 " +
                                    ...
                                    " WHERE Sk_NodoContable = (SEL Sk_NodoContable FROM  " + instancia + ".V_RC_NodoContableAgregacionNumerales WHERE Desc_NodoContable = ? AND Id_NodoContable = ? AND Id_Estructura =?);"+
                                     " INSERT INTO " + instancia + ".V_RC_Rel_NodoAgrNumerales_NumeralCambiario " +
                                                    " (Sk_NodoContable, Id_Fuente, Sk_RCNumeralCambiario, Sk_Lote, Sk_Lote_Upd, Cod_Severidad)" +
                                                    " Values" +
                                ...
                                TdParameter Desc_NodoContablep = oSqlCmd.CreateParameter();
                                Desc_NodoContablep.DbType = DbType.String;
                                Desc_NodoContablep.Direction = ParameterDirection.Input;
                                oSqlCmd.Parameters.Add(Desc_NodoContablep);
                                Desc_NodoContablep.Value = nodo.Desc_NodoContablePadre;
                                ...
                                Desc_NodoContable2.Direction = ParameterDirection.Input;
                                oSqlCmd.Parameters.Add(Desc_NodoContable2);
                                Desc_NodoContable2.Value = nodo.name;
                                ...
                                Desc_NodoContable3.Direction = ParameterDirection.Input;
                                oSqlCmd.Parameters.Add(Desc_NodoContable3);
                                Desc_NodoContable3.Value = nodo.name;
                                ...
                                using (TdCommand oSqlCmd = new TdCommand())
                                {
                                    ...
                                    oSqlCmd.Parameters.Clear();
                                        oSqlCmd.CommandText =
                                             ...
                                             " FROM( " +
                                             " SELECT (SEL Sk_NodoContable FROM " + instancia +".V_RC_NodoContableAgregacionNumerales WHERE Id_Estructura = ? AND Id_NodoContable = ? AND Desc_NodoContable = ? ) sk_nodocontable, " +
                                             " (SEL Sk_NodoContable FROM " + instancia +".V_RC_NodoContableAgregacionNumerales WHERE Id_NodoContable = ? AND Id_Estructura = ? AND Desc_NodoContable = ? " +
                                             "  AND Sk_NodoContablePadre=(SEL Sk_NodoContable FROM " + instancia +".V_RC_NodoContableAgregacionNumerales WHERE Id_Estructura = ? AND Id_NodoContable = ? AND Desc_NodoContable = ?) )sk_nodocontablerelacionado ," +
                                    ...
                                    Desc_NodoContable3.Direction = ParameterDirection.Input;
                                    oSqlCmd.Parameters.Add(Desc_NodoContable3);
                                    Desc_NodoContable3.Value = formulacion.name;
                                    ...
                                    Desc_NodoContable4.Direction = ParameterDirection.Input;
                                    oSqlCmd.Parameters.Add(Desc_NodoContable4);
                                    Desc_NodoContable4.Value = nodo2.name;
